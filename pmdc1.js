  ...
  function renderAllQuestions(){
    ...
    currentQuestions.forEach(function(q, qIdx){
      ...
      optionKeys.forEach(function(key, idx){
        ...
        html += '<div class="opt-' + qIdx + '-' + letter + '" data-letter="' + letter + '" data-qidx="' + qIdx + '" style="display:flex;align-items:center;gap:10px;padding:12px 14px;border:1px solid var(--contentL);border-radius:var(--linkR);cursor:pointer;transition:var(--trans-2);background:var(--contentBa;">' +

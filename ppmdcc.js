  ...
  function renderAllQuestions(){
    ...
    currentQuestions.forEach(function(q, qIdx){
      ...
      html += '<div style="margin:12px 0 0 0;">' +
        '<button class="expToggle-' + qIdx + '" style="cursor:pointer;font-size:13px;padding:8px 14px;margin:0;display:inline-flex;align-items:center;gap:8px;border:1px solid var(--contentL);border-radius:var(--linkR);background:var(--contentBa);font-family:var(--fontB);color:var(--bodyC);">' +
